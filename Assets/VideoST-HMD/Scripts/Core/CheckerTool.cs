/*==============================================================================
Copyright (c) 2015, Seung-Tak Noh (seungtak.noh [at] gmail.com)
All rights reserved.
==============================================================================*/
using UnityEngine;
using System;
...
public class CheckerTool : MonoBehaviour
{
    ...
    public GameObject mVirtualObjectRoot;
    ...
    void Update()
    {
        ...
        {
            // id0: OvrVision - Left
            Ovrvision ovr_script = GameObject.Find("OvrvisionSDK").GetComponent<Ovrvision>();
        ...
        if (find_checker)
        {
            ...
            {
                GameObject leftCam = GameObject.Find("LeftEyeAnchor");
                ...
                ConvertCoord.RT2ObjectTransform(leftCam.transform, mVirtualObjectRoot.transform, r3x3_id0, t3x1_id0);
            }
            else
            {
